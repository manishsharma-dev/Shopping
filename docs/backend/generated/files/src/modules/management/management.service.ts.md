...
[Source](../../../../../../../apps/backend/src/modules/management/management.service.ts) | [Guide](../../../../../features/management.md) | [Guide](../../../../../database.md) | [Guide](../../../../../api.md) | [Guide](../../../../../features/user-types.md)

Source SHA-256: `ea2932d0b7973309a3cb70b57dcc3d7d9d9127c0e5546328b343af85cd34b305`.
...
Inheritance: `implements OnModuleInit`
...
| geography | async geography() |
| validateRegion | private async validateRegion(     state: string &#124; null,     district: string &#124; null,     districtRequired: boolean,   ) |
| availableTypes | private availableTypes(u: Actor, rows: ManagementRecord[]) |
| selectableType | private selectableType(u: Actor, rows: ManagementRecord[], id: unknown) |
| capabilities | async capabilities(u: Actor) |
...
| apply | async apply(_actor: Actor, _d: Record&lt;string, any&gt;) |
...
| saveType | private async saveType(actor: Actor, dto: ManagementDto, id?: string) |
